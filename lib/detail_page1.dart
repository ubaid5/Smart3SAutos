                            ...
                            children: <Widget>[
                              Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Text(_services![0].type as String),
                                  Text(_services![0].price as String),
                                ],
                              ),
                              Image.asset(
                                "",
                          ...
                          Container(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Text(_services![0].workshopName as String),
                              ],
                            ),
                          ),
                        ],
                          ...
                          Container(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Text(_services![0].phone as String),
                              ],
                            ),
                          ),
                        ],
              ...
              child: ListView(
                children: <Widget>[
                  ...
                  Padding
                    ...
                    child: Text( _services![0].serviceDetail),
                  ),
                ],
              ),
            ),
